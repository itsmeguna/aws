...
INPUT_FILE="input.txt"  # Replace with the list of alarm names you want to create
...
do
  ...
  do
    ...
    DIMENSIONS="[{\"Name\":\"path\",\"Value\":\"/\"},{\"Name\":\"host\",\"Value\":\"ip-$IP_ADDRESS\"},{\"Name\":\"device\",\"Value\":\"nvme0n1p1\"},{\"Name\":\"fstype\",\"Value\":\"ext4\"}]"
